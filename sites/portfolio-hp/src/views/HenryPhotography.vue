...
<template>
    ...
    <div class="grid gap-6 md:grid-cols-3">
      ...
      >
        ...
        <p class="text-sm text-gray-600">
          Love capturing homes and buildings from angles you can't see from the
          ground. There's something fascinating about the geometry and scale
          from above.
        </p>
      </div>
      <div
      ...
      >
        ...
        <p class="text-sm text-gray-600">
          ...
          above. Hill Country and coastal areas offer amazing opportunities for
          aerial shots.
        </p>
      </div>
      <div
      ...
      >
        ...
        <p class="text-sm text-gray-600">
          Always trying new techniques and perspectives. The intersection of my
          pilot training and creative interests makes for some interesting
          compositions.
        </p>
      </div>
    </div>
  ...
  >
    ...
    <p class="mx-auto mb-6 max-w-2xl text-gray-600">
      ...
      interested in chatting about either (or want to see more shots), feel free
      to reach out.
    </p>
